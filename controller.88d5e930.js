...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){return function(t,e,o,i){this.size=t,this.initialInput=e,this.expectedOutput=o,this.description=i,this.actualOutput=[],this.input=[],this.completed=!1}}(),e=new t(3,[0,0,0],[0,0,0],"Move the boxes to the return square"),o=new t(5,[0,0,0],[1,1,1],"Add one to each box"),i=new t(5,[1,2,3],[-2,-1,0],"Subtract three from each box"),u=new t(5,[4,2,-2],[0,0,0],"Output zero for all inputs"),n={name:"Two and a half boxes",description:"Divide the input by two",input:[2,6,-4],output:[1,3,-2],size:5},s={name:"Two and a half boxes 2: Electric boogaloo",description:"Divide the input by two, round up for odd numbers",input:[2,3,7,-3,-4],output:[1,2,4,-2,-2],size:7},p={name:"Remember the last one",description:"Add the previous output to the input",input:[1,1,1],output:[1,2,3],size:5},r=[e,o,i,u];exports.default=r;
},{}],"PUau":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var r=require("./types"),t=require("./objects/conveyors"),o=e(require("./levels")),n=function(){return function(){var e=this;this.menu={selectedConveyor:r.Conveyors.Base,selectedMemory:r.MemoryType.A,selectedDirection:r.Direction.Down,selectedLevel:0},this.level=o.default[this.menu.selectedLevel],this.levelOperations={nextLevel:function(){e.menu.selectedLevel!=o.default.length-1&&(e.menu.selectedLevel+=1,e.levelOperations.updateLevel())},prevLevel:function(){0!=e.menu.selectedLevel&&(e.menu.selectedLevel-=1,e.levelOperations.updateLevel())},updateLevel:function(){e.level=o.default[e.menu.selectedLevel]}},this.box={x:0,y:0,value:0,returned:!1},this.boxOperations={},this.board={memory:{A:0,B:0,C:0},resetMemory:function(){e.board.memory.A=0,e.board.memory.B=0,e.board.memory.C=0},grid:[],createGrid:function(o){var n=Array(o).fill(void 0).map(function(){return Array(o).fill(void 0)});e.board.grid=n.map(function(e){return e.map(function(){return t.ConveyorFactory(r.Conveyors.Base,r.Direction.Up,void 0,void 0)})})},resetGrid:function(){e.board.createGrid(e.level.size),e.board.grid[0][0]=t.ConveyorFactory(r.Conveyors.Mover,r.Direction.Down,void 0,void 0)},updateGrid:function(r,o){e.board.grid[r][o]=t.ConveyorFactory(e.menu.selectedConveyor,e.menu.selectedDirection,e.menu.selectedMemory,e.board.memory)}},this.levelIndex=0,this.board.resetGrid(),this.box=void 0}}();exports.StateClass=n;
},{"./types":"Qd94","./objects/conveyors":"f31C","./levels":"kM9h"}],"KzVE":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var r=require("../types");exports.keyToDirection=function(e){switch(e){case"ArrowUp":return r.Direction.Up;case"ArrowDown":return r.Direction.Down;case"ArrowLeft":return r.Direction.Left;case"ArrowRight":return r.Direction.Right;default:return}},exports.stringToDirection=function(e){switch(e){case"up":return r.Direction.Up;case"down":return r.Direction.Down;case"left":return r.Direction.Left;case"right":return r.Direction.Right}},exports.stringToConveyor=function(e){switch(e){case"base":return r.Conveyors.Base;case"mover":return r.Conveyors.Mover;case"adder":return r.Conveyors.Adder;case"subtractor":return r.Conveyors.Subtractor;case"memory_assigner":return r.Conveyors.MemoryAssigner;case"memory_adder":return r.Conveyors.MemoryAdder;case"memory_subtractor":return r.Conveyors.MemorySubtractor;case"memory_splitter":return r.Conveyors.MemorySplitter;case"returner":return r.Conveyors.Returner}};
},{"../types":"Qd94"}],"CBC0":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./types"),t=require("./image-loader"),r=require("./utils/stringTo"),n=function(){return function(n){var o=this;this.updateLevelView=function(e,t){document.querySelector("#level_name").innerHTML="Level: "+(e+1),document.querySelector("#level_description").innerHTML=t.description,document.querySelector("#input").innerHTML=t.initialInput.toString(),document.querySelector("#output").innerHTML=t.expectedOutput.toString(),document.querySelector("#level_status").innerHTML=t.completed?"done_outline":"clear",document.querySelector("#level_status").style.color=t.completed?"green":"red"},this.updateMemoryView=function(e){document.querySelector("#memory_a_display").innerHTML=e.A.toString(),document.querySelector("#memory_b_display").innerHTML=e.B.toString(),document.querySelector("#memory_c_display").innerHTML=e.C.toString()},this.drawBox=function(e,r){if(null!=e){var n=o.canvas.width,i=o.canvas.height;o.ctx.fillStyle="#000000";var a=t.getBoxImage(),c=t.getNumberImage(e.value);if(o.ctx.drawImage(a,n/r*e.x,i/r*e.y,n/r,i/r),o.ctx.drawImage(c.ones,n/r*e.x,i/r*e.y,n/r,i/r),o.ctx.drawImage(c.tens,n/r*e.x,i/r*e.y,n/r,i/r),c.isNegative){var u=t.getMinusImage();o.ctx.drawImage(u,n/r*e.x,i/r*e.y,n/r,i/r)}}},this.drawCells=function(e,r){for(var n=o.canvas.width,i=o.canvas.height,a=0;a<e.length;a++)for(var c=0;c<e.length;c++){var u=e[a][c],s=t.getImage(u.direction,u.type);if(o.ctx.drawImage(s,n/r*a,i/r*c,n/r,i/r),null!=u.memory_type){var l=t.getBorderImage(u.memory_type);o.ctx.drawImage(l,n/r*a,i/r*c,n/r,i/r)}}},this.initializeCanvas=function(){o.canvas.setAttribute("height","384"),o.canvas.setAttribute("width","384"),o.clearCanvas()},this.clearCanvas=function(){o.ctx.fillStyle="#eeeeee",o.ctx.fillRect(0,0,o.canvas.width,o.canvas.height)},this.setConveyorButtonBorderColor=function(e){document.querySelectorAll(".conveyor_buttons").forEach(function(e){e.style.borderColor="#000000"}),e.style.borderColor="#00FF00"},this.initializeButtons=function(r){o.updateConveyorButtonImages(r),o.directionButtons.forEach(function(r){var n=void 0;switch(r.id){case"up":n=e.Direction.Up;break;case"down":n=e.Direction.Down;break;case"left":n=e.Direction.Left;break;case"right":n=e.Direction.Right}var o=t.getImage(n,e.Conveyors.Mover).src;r.setAttribute("src",o)}),document.querySelector("#base").style.borderColor="#00FF00",o.menuButtons.forEach(function(e){e.ondragstart=function(e){e.preventDefault()}})},this.updateConveyorButtonImages=function(e){o.conveyorButtons.forEach(function(n){var o=t.getImage(e,r.stringToConveyor(n.getAttribute("id"))).src;n.setAttribute("src",o)})},this.canvas=document.querySelector("#canvas"),this.ctx=this.canvas.getContext("2d"),this.initializeCanvas(),this.menuButtons=document.querySelectorAll(".menu_buttons"),this.conveyorButtons=document.querySelectorAll(".conveyor_buttons"),this.directionButtons=document.querySelectorAll(".direction_buttons"),this.initializeButtons(n)}}();exports.ViewClass=n;
},{"./types":"Qd94","./image-loader":"EvhF","./utils/stringTo":"KzVE"}],"yDl0":[function(require,module,exports) {
"use strict";var e=this&&this.__spreadArrays||function(){for(var e=0,t=0,o=arguments.length;t<o;t++)e+=arguments[t].length;var n=Array(e),a=0;for(t=0;t<o;t++)for(var i=arguments[t],r=0,s=i.length;r<s;r++,a++)n[a]=i[r];return n};Object.defineProperty(exports,"__esModule",{value:!0});var t=require("./state"),o=require("./view"),n=require("./utils/stringTo"),a=require("./types"),i=function(){var e=document.getElementById("grid"),t=e.parentElement.clientWidth,o=e.parentElement.clientHeight,n=t>o?o:t;e.style.height=n+"px",e.style.width=1.5*n+"px",t>1.5*o&&(e.style.height=o+"px",e.style.width=1.5*o+"px"),1.5*o>t&&(e.style.height=2*t/3+"px",e.style.width=t+"px")},r=function(){return function(){var i=this;this.gameLoop={timerId:void 0,isRunning:!1,update:function(){if(null==i.state.box)i.state.box={x:0,y:0,value:i.state.level.input.shift(),returned:!1};else{var e=i.state.box.x,t=i.state.box.y;i.state.board.grid[e][t].update(i.state.box)}return i.state.box.returned&&(i.state.level.actualOutput.push(i.state.box.value),i.state.box=void 0),i.gameLoop.failureStateDetector()?(i.gameLoop.stop(),void console.log("failed")):i.state.level.actualOutput.length===i.state.level.expectedOutput.length?(i.state.level.completed=!0,void i.gameLoop.stop()):void i.gameLoop.draw()},draw:function(){i.view.clearCanvas(),i.view.drawCells(i.state.board.grid,i.state.level.size),i.view.drawBox(i.state.box,i.state.level.size),i.view.updateMemoryView(i.state.board.memory)},failureStateDetector:function(){var e=!i.state.level.actualOutput.every(function(e,t){return e===i.state.level.expectedOutput[t]});return void 0===i.state.box?e:i.state.box.x<0||i.state.box.y<0||i.state.box.x>=i.state.level.size||i.state.box.y>=i.state.level.size},start:function(){i.gameLoop.isRunning||(i.gameLoop.isRunning=!0,i.state.level.input=e(i.state.level.initialInput),i.gameLoop.timerId=setInterval(i.gameLoop.update,300))},stop:function(){i.gameLoop.isRunning=!1,clearInterval(i.gameLoop.timerId),i.state.box=void 0,i.state.board.resetMemory(),i.state.level.actualOutput=[],i.view.updateLevelView(i.state.menu.selectedLevel,i.state.level),i.gameLoop.draw()}},this.nextLevelOnClick=function(){i.gameLoop.isRunning||(i.state.levelOperations.nextLevel(),i.view.updateLevelView(i.state.menu.selectedLevel,i.state.level),i.state.board.resetGrid(),i.gameLoop.draw())},this.prevLevelOnClick=function(){i.gameLoop.isRunning||(i.state.levelOperations.prevLevel(),i.view.updateLevelView(i.state.menu.selectedLevel,i.state.level),i.state.board.resetGrid(),i.gameLoop.draw())},this.conveyorButtonOnClick=function(e){var t=e.target;i.state.menu.selectedConveyor=n.stringToConveyor(t.id),i.view.setConveyorButtonBorderColor(t)},this.arrowKeyOnPress=function(e){var t=n.keyToDirection(e.key);null!=t&&(i.state.menu.selectedDirection=t,i.view.updateConveyorButtonImages(i.state.menu.selectedDirection))},this.directionButtonOnClick=function(e){var t=e.target;i.state.menu.selectedDirection=n.stringToDirection(t.id),i.view.updateConveyorButtonImages(i.state.menu.selectedDirection)},this.memoryOnClick=function(e){switch(e.target.value){case"a":i.state.menu.selectedMemory=a.MemoryType.A;break;case"b":i.state.menu.selectedMemory=a.MemoryType.B;break;case"c":i.state.menu.selectedMemory=a.MemoryType.C}},this.canvasOnClick=function(e){if(!i.gameLoop.isRunning){var t=e.target.clientHeight/i.state.level.size,o=Math.floor(e.offsetX/t),n=Math.floor(e.offsetY/t);0==o&&0==n||(i.state.board.updateGrid(o,n),i.gameLoop.draw())}},this.state=new t.StateClass,this.view=new o.ViewClass(this.state.menu.selectedDirection),document.querySelector("#canvas").onclick=this.canvasOnClick,document.querySelectorAll(".conveyor_buttons").forEach(function(e){e.onclick=i.conveyorButtonOnClick}),document.querySelectorAll(".direction_buttons").forEach(function(e){e.onclick=i.directionButtonOnClick}),document.querySelectorAll(".memory_buttons").forEach(function(e){e.onclick=i.memoryOnClick}),document.querySelector("#prev_level").onclick=this.prevLevelOnClick,document.querySelector("#next_level").onclick=this.nextLevelOnClick,document.querySelector("#play_button").onclick=this.gameLoop.start,document.querySelector("#stop_button").onclick=this.gameLoop.stop,document.querySelector("#mover").onload=this.gameLoop.draw,this.view.updateLevelView(this.state.menu.selectedLevel,this.state.level),document.onkeydown=this.arrowKeyOnPress}}();window.onload=i,window.onresize=i,new r;
},{"./state":"PUau","./view":"CBC0","./utils/stringTo":"KzVE","./types":"Qd94"}]},{},["yDl0"], null)
//# sourceMappingURL=controller.88d5e930.js.map